...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    chapter: { fa: "Vibe Coding For Product Designers", en: "Vibe Coding For Product Designers" },
    body: {
    ...
    episodes: [
      { fa: "What You Can Vibe Code", en: "What You Can Vibe Code" },
      { fa: "GitHub", en: "GitHub" },
      { fa: "Deployment", en: "Deployment" },
      { fa: "Build the Project", en: "Build the Project" },
    ],
    tint: "#94a8f0", // 8.1:1
    hi: "#5a78dc",
    base: "#1d3080",
