...
export interface Course {
  ...
  projects: number;
  // ── فیلدهای دورهٔ زمان‌دار (تاریخ شروع، طول، قالب) ──
...
const uiTopics: CourseTopic[] = [
  ...
  { title: "Chapter 21: Instagram Dashboard (Project)", description: "پروژه دوم: طراحی داشبورد تحلیل اینستاگرام — پیچیده، واقعی و اضافه‌شدنی به پرتفولیو." },
...
const uxTopics: CourseTopic[] = [
  ...
  { title: "Chapter 23: Case Study", description: "ساختار یه Case Study حرفه‌ای برای پرتفولیو که استخدام‌کننده رو متقاعد کنه." },
  { title: "Chapter 24: Instagram Redesign (Project)", description: "پروژه نهایی: ریدیزاین کامل تجربه‌ی اینستاگرام — از تحقیق تا Case Study آماده‌ی پرتفولیو." },
];
...
const uiTargetAudience = [
  ...
  "کسی که می‌خواد پرتفولیو واقعی بسازه و وارد بازار کار بشه",
];

const uiAfterCompletion = [
  "۵ پروژه واقعی آماده برای پرتفولیو — از اپ پادکست تا Design System",
...
const uxLearningOutcomes = [
  ...
  "نوشتن Case Study حرفه‌ای برای پرتفولیو",
];
...
const uxTargetAudience = [
  ...
  "کسی که پرتفولیو UX ضعیف داره یا اصلاً نداره",
];

const uxAfterCompletion = [
  "یه Case Study کامل از پروژه واقعی — آماده برای پرتفولیو",
...
const uiInfinityFAQs: FAQ[] = [
  ...
  { q: "بعد از دوره چی می‌تونم انجام بدم؟", a: "پرتفولیو داری با ۵ پروژه واقعی. آماده‌ای برای ورود به بازار کار به عنوان طراح UI یا ادامه با دوره UX." },
];
...
const uxInfinityFAQs: FAQ[] = [
  ...
  { q: "جلسات منتورینگ چطوره؟", a: "جلسات گروهی آنلاین هستن — هر هفته یه جلسه. پروژه‌ها بررسی میشن، سوال می‌پرسی و فیدبک مستقیم می‌گیری. از فیدبک بقیه هم یاد می‌گیری." },
  { q: "پروژه‌ها رو فردی انجام بدم یا گروهی؟", a: "هر دو ممکنه. می‌تونی فردی کار کنی یا با یه هم‌دوره‌ای گروه تشکیل بدی. کار گروهی تجربه team work واقعی میده که تو پرتفولیوت نشون می‌ده." },
  { q: "اگه یه جلسه منتورینگ رو از دست بدم چی میشه؟", a: "همه جلسات ضبط میشن و بعد از جلسه در دسترسته. هیچ جلسه‌ای از دست نمیره." },
  { q: "بعد از دوره چی می‌تونم انجام بدم؟", a: "یه Case Study کامل و پرتفولیو UX داری. می‌تونی موقعیت UX Researcher یا UX Designer رو دنبال کنی." },
];
...
const uiOfflineFAQs: FAQ[] = [
  ...
  { q: "بعد از دوره چی می‌تونم انجام بدم؟", a: "پرتفولیو داری با ۵ پروژه واقعی. آماده‌ای برای ورود به بازار کار به عنوان طراح UI." },
];
...
// ─── Workshop: پرامپت تا پروداکت ─────────────────────────────
// سه جلسه‌ی ۳ ساعته. تمرکز روی نیازِ طراحِ شاغل در عصر AI، نه روی یک ابزارِ خاص.
// مسیر: از پرامپت و ایده، با Figma AI به رابط، با Claude Code به کدِ زنده،
// و در نهایت دیپلوی روی Vercel.
const promptToProductTopics: CourseTopic[] = [
  { title: "جلسه ۱ · طراح در عصرِ AI", description: "ترسِ عقب‌موندن رو تبدیل کن به مزیت: چی عوض شد، چه مهارتی حالا طلاست و کجا AI جایگزینِ طراح نمی‌شه." },
  { title: "جلسه ۱ · زبانِ گفتگو با AI", description: "ساختنِ بریف، دادنِ context، تعریفِ persona و محدودیت‌ها، و ساختِ کتابخانه‌ی پرامپتِ شخصی که مالِ خودت می‌مونه." },
  { title: "جلسه ۱ · از ایده تا کانسپت", description: "ایده‌پردازی، ساختِ user flow و نوشتنِ متن‌های UI و microcopy — سریع، ولی با قضاوتِ طراح." },
  { title: "جلسه ۱ · ساختنِ رابط با Figma AI", description: "تولید و ویرایشِ سریعِ رابط با Figma AI، و مهم‌تر: نقد و پالایشِ خروجی با چشمِ یه طراحِ بلد." },
  { title: "جلسه ۲ · دیزاین‌سیستمِ سریع", description: "تعریفِ توکن، نام‌گذاری و مستندسازیِ کامپوننت‌ها با کمکِ AI، تا طرح آماده‌ی تبدیل به کد بشه." },
  { title: "جلسه ۲ · پل به کد با Claude Code", description: "تبدیلِ طرحِ فیگما به یه فرانت‌اندِ واقعی و کارآمد با Claude Code، بدونِ اینکه برنامه‌نویس باشی." },
  { title: "جلسه ۲ · تعامل و حالت‌ها", description: "افزودنِ تعامل، حالت‌های خالی و خطا و لودینگ، و ریسپانسیو کردن — همه با هدایتِ تو." },
  { title: "جلسه ۳ · دیپلوی روی Vercel", description: "از کدِ لوکال تا محصولِ آنلاین: یه لینکِ واقعی و قابل‌ارائه که با موبایل هم باز می‌شه." },
  { title: "جلسه ۳ · خودکارسازیِ کارهای تکراری", description: "ممیزیِ accessibility، ریسرچِ رقبا و تولیدِ حالت‌ها با ایجنت‌ها و workflowها، نه فقط چت." },
  { title: "جلسه ۳ · پرتفولیوی AI-first", description: "ساختِ کیس‌استادی که فرایندِ AI-first رو نشون بده — همون چیزی که الان یه تمایزِ استخدامیه." },
];

const promptToProductFAQs: FAQ[] = [
  { q: "این دوره برای منه؟", a: "اگه طراحی که می‌ترسه از موجِ AI عقب بمونه، آره. برای مبتدیِ صفر نیست؛ فرض بر اینه که با طراحی آشنایی داری و می‌خوای AI رو وارد کارِت کنی." },
  { q: "چطور برگزار می‌شه؟", a: "ویدیویی و ماژول‌به‌ماژول، روی یه پروژه‌ی واقعی که تا دیپلوی جلو می‌ره. هر ماژول یه خروجیِ مشخص داره که ماژول بعد ازش شروع می‌کنه." },
  { q: "باید کد بلد باشم؟", a: "نه. پل به کد با Claude Code انجام می‌شه و تو هدایتش می‌کنی؛ خودت خط‌به‌خط نمی‌نویسی، ولی می‌فهمی چی داره می‌سازه." },
  { q: "چه ابزارهایی لازمه؟", a: "Figma برای طراحی (با Figma AI)، Claude Code برای کد، و یه اکانتِ رایگان Vercel برای دیپلوی. توی دوره راه‌اندازی‌شون رو نشون می‌دم." },
  { q: "تا کِی به ویدیوها دسترسی دارم؟", a: "همیشه. ویدیوها بعد از خرید مالِ خودتن و محدودیت زمانی ندارن." },
];
...
const allCourses: Course[] = [
  ...
  // ── دوره: پرامپت تا پروداکت ──────────────────────────
  {
    ...
    description:
      "یه دوره برای طراحی که نمی‌خواد از موجِ AI عقب بمونه — از پرامپت و ایده، با Figma AI و Claude Code، تا یه محصولِ دیپلوی‌شده روی Vercel.",
    longDescription:
      "این دوره برای طراحیه که کارش رو بلده ولی می‌ترسه از AI عقب بمونه. یه فیچرِ واقعی رو کامل جلو می‌بریم: از بریف و ایده، به رابط با Figma AI، به کدِ زنده با Claude Code، و در نهایت دیپلوی روی Vercel با یه لینکِ قابل‌ارائه. تمرکز روی یک ابزار نیست؛ روی طرزِ فکرِ AI-first و قضاوتِ طراحه — چیزی که هیچ ابزاری جاش رو نمی‌گیره.",
    price: 8000000,
    thumbnail: "",
    videoHours: 0,
    mentoringHours: 0,
    ...
    projects: 0,
    durationHours: 9,
    sessionDate: "شهریور ۱۴۰۵",
    format: "آنلاین · ۳ جلسه‌ی ۳ ساعته",
    level: "متوسط",
    students: 0,
    tags: ["AI", "Figma AI", "Claude Code", "Vercel", "Product Design"],
    topics: promptToProductTopics,
    features: [
      "۹ ساعت ویدیوی آموزشی",
      "یه فیچرِ واقعی از پرامپت تا دیپلوی روی Vercel",
      "کارِ عملی با Figma AI و Claude Code",
      "کتابخانه‌ی پرامپت + فایل‌های آموزشی",
      "دسترسی دائمی به ویدیوها",
    ],
    faqs: promptToProductFAQs,
    learningOutcomes: [
      "طرزِ فکرِ AI-first: هدایتِ AI به‌جای ترس از جایگزین‌شدن",
      "زبانِ گفتگو با AI برای کارهای طراحی + کتابخانه‌ی پرامپت شخصی",
      "ساختنِ سریعِ رابط با Figma AI و نقدِ خروجی با چشمِ طراح",
      "تبدیلِ طرح به فرانت‌اندِ واقعی با Claude Code بدون برنامه‌نویسی",
      "دیپلویِ محصول روی Vercel و گرفتنِ یه لینکِ قابل‌ارائه",
      "ساختِ کیس‌استادیِ AI-first برای پرتفولیو",
    ],
    targetAudience: [
      "طراحِ شاغلی که می‌ترسه از موجِ AI عقب بمونه",
      "طراحی که می‌خواد از ایده سریع به یه محصولِ زنده برسه",
      "کسی که می‌خواد بدون برنامه‌نویس، طرحش رو به کدِ دیپلوی‌شده برسونه",
      "برای مبتدیِ صفر نیست؛ آشنایی پایه با طراحی لازمه",
    ],
    afterCompletion: [
      "یه محصولِ واقعیِ دیپلوی‌شده روی Vercel، از پرامپت تا لینک",
      "کتابخانه‌ی پرامپتِ آماده برای کارهای طراحی",
      "کیس‌استادیِ AI-first برای پرتفولیو",
      "فایل‌های آموزشی و ضبطِ کامل سه جلسه",
    ],
    instructor: "مجتبا یزدانپناه",
    isNew: true,
    comingSoon: true,
    // موقتاً مخفی — تا وقتی روی دوره کار کنیم. برای برگردوندن، این خط رو بردار.
    hidden: true,
    testimonials: [],
  },
];
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: "پرتفولیویی که کارفرما تا آخر می‌خونه",
    excerpt: "بیشتر پرتفولیوها گالری تصویرن. چیزی که استخدام‌کننده دنبالشه، طرز فکر شماست نه تعداد صفحه‌هاتون.",
    body: [
      "یک استخدام‌کننده در بهترین حالت چند دقیقه به پرتفولیوی شما وقت می‌ده. توی این چند دقیقه دنبال یک چیزه: آیا این آدم بلده مسئله رو حل کنه یا فقط بلده فتوشاپ و فیگما کار کنه.",
      "برای همین سه تا پروژه‌ی عمیق خیلی بهتر از ده تا پروژه‌ی سطحیه. پروژه‌هایی که ضعیف‌ترن، سطح کل پرتفولیو رو پایین می‌کشن. بی‌رحم باشید و حذف کنید.",
