...
const promptToProductFAQs: FAQ[] = [
  { q: "این کارگاه برای منه؟", a: "اگه طراحی که می‌ترسه از موجِ AI عقب بمونه، آره. برای مبتدیِ صفر نیست؛ فرض بر اینه که با طراحی آشنایی داری و می‌خوای AI رو وارد کارِت کنی." },
  { q: "چند جلسه‌ست و چطور برگزار می‌شه؟", a: "سه جلسه‌ی زنده‌ی آنلاینِ ۳ ساعته، به‌صورت تعاملی و دستی روی یه پروژه‌ی واقعی که تا دیپلوی جلو می‌ره." },
  ...
  { q: "چه ابزارهایی لازمه؟", a: "Figma برای طراحی (با Figma AI)، Claude Code برای کد، و یه اکانتِ رایگان Vercel برای دیپلوی. توی کارگاه راه‌اندازی‌شون رو نشون می‌دم." },
  { q: "جلسات ضبط می‌شن؟", a: "بله، هر سه جلسه ضبط می‌شن و بعد از کارگاه در دسترست هستن." },
];
...
const allCourses: Course[] = [
  ...
  // ── Workshop: پرامپت تا پروداکت ──────────────────────────
  {
    ...
    description:
      "سه جلسه‌ی زنده برای طراحی که نمی‌خواد از موجِ AI عقب بمونه — از پرامپت و ایده، با Figma AI و Claude Code، تا یه محصولِ دیپلوی‌شده روی Vercel.",
    longDescription:
      "این کارگاه برای طراحیه که کارش رو بلده ولی می‌ترسه از AI عقب بمونه. در سه جلسه‌ی ۳ ساعته یه فیچرِ واقعی رو کامل جلو می‌بریم: از بریف و ایده، به رابط با Figma AI، به کدِ زنده با Claude Code، و در نهایت دیپلوی روی Vercel با یه لینکِ قابل‌ارائه. تمرکز روی یک ابزار نیست؛ روی طرزِ فکرِ AI-first و قضاوتِ طراحه — چیزی که هیچ ابزاری جاش رو نمی‌گیره.",
    price: 5000000,
    thumbnail: "",
    videoHours: 0,
    mentoringHours: 0,
    ...
    features: [
      "۳ جلسه‌ی زنده‌ی ۳ ساعته (جمعاً ۹ ساعت)",
